...
from Lib.WebDriver.Decorator import logger_browser
from Utils.ParseConfig import WAIT_UNTIL_TIMEOUT, WAIT_FREQUENCY
from Utils.Paths import LAST_SCREENSHOTS_DIR
...
class Browser(metaclass=MetaDecorator):
    ...
    def take_screenshot(self, filename):
        ...
        if not os.path.exists(LAST_SCREENSHOTS_DIR):
            os.makedirs(LAST_SCREENSHOTS_DIR)
        filepath = os.path.join(LAST_SCREENSHOTS_DIR, _filename)
